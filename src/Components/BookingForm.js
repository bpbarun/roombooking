...
<div className="row">
    <div className="col-4">
        <div className="bg-thumbnail bg-img firstImage">
            <img className="firstImage" src={IP +`/rooms-image/`+'1.png'} alt=""/>
        </div>
    </div>
    <div className="col-8">
        <form>
        ...
        <div class="form-group">
            <label for="requests">Checkout</label>
            <input type="button" id="requests" className="primary"/>
        </div>
    </form>
    </div>
</div>
